...
//        bizContent.set("name", aliPayVo.getName());   // 支付的名称
        bizContent.set("subject",aliPayVo.getSubject());
        // order_number
//        bizContent.set("no", aliPayVo.getNo());  // 我们自己生成的订单编号
        bizContent.set("out_trade_no",aliPayVo.getTraceNo());
        // order_price
//        bizContent.set("price", aliPayVo.getPrice()); // 订单的总金额
...
//
//                if (orderModel != null) {
//                    orderModel.setOrderNumber(alipayTradeNo);
